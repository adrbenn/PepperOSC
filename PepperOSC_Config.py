...
# where the sound generator is
# soundIP = "127.0.0.1"         # if it's this computer
soundIP = "192.168.100.116"
soundPort = 3005

own_behavior_names = ["None",
                      ".lastUploadedChoregrapheBehavior/R-cond1",
                      ".lastUploadedChoregrapheBehavior/R-cond2",
                      ".lastUploadedChoregrapheBehavior/R-cond3",
                      ".lastUploadedChoregrapheBehavior/R-cond4",
                      ".lastUploadedChoregrapheBehavior/R-cond5",
                      ".lastUploadedChoregrapheBehavior/R-cond6",
                      ".lastUploadedChoregrapheBehavior/L-cond1",
                      ".lastUploadedChoregrapheBehavior/L-cond2",
                      ".lastUploadedChoregrapheBehavior/L-cond3",
                      ".lastUploadedChoregrapheBehavior/L-cond4",
                      ".lastUploadedChoregrapheBehavior/L-cond5",
                      ".lastUploadedChoregrapheBehavior/L-cond6",
                      ".lastUploadedChoregrapheBehavior/hand-reset"
                      ]


behavior_names = ["animations/Stand/BodyTalk/Listening/Listening_1",    # 0
